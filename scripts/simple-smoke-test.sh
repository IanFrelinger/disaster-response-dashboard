...
# 🧪 Simple Smoke Test for Simplified Disaster Response Dashboard
# Focuses on API functionality and basic connectivity

echo "🧪 Starting Simple Smoke Test for Simplified Disaster Response Dashboard"
echo "======================================================================"
...
run_test "API Response Time < 2s" "timeout 2 curl -s http://localhost:5001/api/disaster-data > /dev/null && echo 'fast'" "fast"

# Test frontend load time (more lenient)
run_test "Frontend Load Time < 3s" "timeout 3 curl -s http://localhost:3000 > /dev/null && echo 'fast'" "fast"
