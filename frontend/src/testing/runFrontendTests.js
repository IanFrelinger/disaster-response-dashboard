...
import { TestOrchestrator, OrchestratorConfig } from './orchestrator/TestOrchestrator.ts';
import { FrontendTestSuites } from './suites/FrontendTestSuites.ts';
...
class FrontendTestRunner {
  ...
  async run() {
    ...
    try {
      ...
      // Get test suites
      const suites = FrontendTestSuites.getAllSuites(config.baseUrl);
