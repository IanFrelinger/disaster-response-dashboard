...
# Main function
main() {
    echo "🔧 Setting up CodeBuild IAM Role"
    echo "================================="
    ...
    echo "   aws iam detach-role-policy --role-name ${ROLE_NAME} --policy-arn arn:aws:iam::$(aws sts get-caller-identity --query Account --output text):policy/CodeBuildServicePolicy"
