...
class EnhancedCaptureGenerator {
  ...
  async initialize(): Promise<void> {
    console.log('🚀 Initializing Enhanced Capture Generator...');
  ...
  async generatePersonalIntro(): Promise<void> {
    ...
    // Create a personal introduction screen
    ...
    // Start recording
    await this.page.video()?.saveAs(path.join(this.capturesDir, 'personal_intro.webm'));
    
    // Wait for duration
    await this.page.waitForTimeout(15000);
    
    console.log('✅ Personal Introduction capture completed');
  }
  ...
  async generateUserPersona(): Promise<void> {
    ...
    // Create a user persona definition screen
    await this.page.setContent(`
      <!DOCTYPE html>
      <html>
        <head>
    ...
    // Start recording
    await this.page.video()?.saveAs(path.join(this.capturesDir, 'user_persona.webm'));
    
    // Wait for duration
    await this.page.waitForTimeout(20000);
    
    console.log('✅ User Persona capture completed');
  }

  async generateFoundryArchitecture(): Promise<void> {
    console.log('📹 Generating Foundry Architecture capture...');
    
    if (!this.page) throw new Error('Page not initialized');
    
    // Create a Foundry architecture diagram
    await this.page.setContent(`
      <!DOCTYPE html>
      <html>
        <head>
    ...
    // Start recording
    await this.page.video()?.saveAs(path.join(this.capturesDir, 'foundry_architecture.webm'));
    
    // Wait for duration
    await this.page.waitForTimeout(50000);
    
    console.log('✅ Foundry Architecture capture completed');
  }

  async generateActionDemonstration(): Promise<void> {
    console.log('📹 Generating Action Demonstration capture...');
    
    if (!this.page) throw new Error('Page not initialized');
    
    // Create an action demonstration screen
    await this.page.setContent(`
      <!DOCTYPE html>
      <html>
        <head>
    ...
    // Start recording
    await this.page.video()?.saveAs(path.join(this.capturesDir, 'action_demonstration.webm'));
    
    // Wait for duration
    await this.page.waitForTimeout(50000);
    
    console.log('✅ Action Demonstration capture completed');
  }
  ...
  async generateStrongCTA(): Promise<void> {
    ...
    // Create a strong call-to-action screen
    await this.page.setContent(`
      <!DOCTYPE html>
      <html>
        <head>
    ...
    // Start recording
    await this.page.video()?.saveAs(path.join(this.capturesDir, 'strong_cta.webm'));
    
    // Wait for duration
    await this.page.waitForTimeout(45000);
    
    console.log('✅ Strong Call-to-Action capture completed');
  }
  ...
  async generateAllCaptures(): Promise<void> {
    try {
      ...
      console.log('🎬 Starting enhanced capture generation...');
      
      await this.generatePersonalIntro();
      await this.generateUserPersona();
      await this.generateFoundryArchitecture();
      await this.generateActionDemonstration();
      await this.generateStrongCTA();
      
      console.log('🎉 All enhanced captures generated successfully!');
      
    } catch (error) {
      console.error('❌ Error generating captures:', error);
    } finally {
      await this.cleanup();
    }
  }
...
export { EnhancedCaptureGenerator };
