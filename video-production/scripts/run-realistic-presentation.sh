...
# Realistic Interactive Presentation Recorder Script
# This script runs a realistic interactive presentation recording with actual UI elements

set -e

echo "🎬 Disaster Response Dashboard - Realistic Interactive Presentation Recorder"
echo "=========================================================================="
...
# Run the realistic interactive presentation recorder
echo "🚀 Starting realistic interactive presentation recording..."
echo "   This will:"
echo "   - Open a browser window and record real UI interactions"
echo "   - Use actual button selectors found in the frontend"
echo "   - Switch between Commander Dashboard and Live Map views"
echo "   - Scroll through dashboard content to show different sections"
echo "   - Generate text-to-speech audio for each beat"
echo "   - Create screenshots for each section"
echo "   - Total duration: ~4 minutes"
echo ""

tsx scripts/realistic-interactive-recorder.ts

echo ""
echo "✅ Realistic interactive presentation recording finished!"
...
echo "📊 Check 'captures/realistic-presentation-report.json' for detailed results"
echo ""
echo "🎬 Next Steps:"
echo "1. Review the recorded realistic video in the captures directory"
