...
# Complete Presentation Recorder Script
# This script runs a complete presentation recording with interactions and text-to-speech

set -e

echo "🎬 Disaster Response Dashboard - Complete Presentation Recorder"
echo "================================================================"
...
# Run the complete presentation recorder
echo "🚀 Starting complete presentation recording..."
echo "   This will:"
...
tsx scripts/complete-presentation-recorder.ts

echo ""
echo "✅ Complete presentation recording finished!"
...
echo "📊 Check 'captures/complete-presentation-report.json' for detailed results"
echo ""
echo "🎬 Next Steps:"
