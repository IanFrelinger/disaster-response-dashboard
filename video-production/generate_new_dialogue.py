#!/usr/bin/env python3
"""
Generate New Dialogue Script
Creates dialogue audio files using ElevenLabs TTS service based on the new narration configuration.
"""
...
def create_elevenlabs_config(narration_config: Dict) -> Dict:
    ...
    config = {
        'voice_id': voice_settings.get('voice_id', 'EXAVITQu4vr4xnSDxMaL'),
...
def create_merged_audio_file(successful_generations: List, output_file: str = "audio/voiceover.wav"):
...
def main():
    ...
    print("🎬 Disaster Response Dashboard - New Dialogue Generator")
    print("=" * 60)
    ...
    config_path = "new_narration.yaml"
    if not os.path.exists(config_path):
        print(f"❌ Configuration file not found: {config_path}")
        print("Please make sure new_narration.yaml exists in the current directory.")
        sys.exit(1)
